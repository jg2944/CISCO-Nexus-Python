#!/usr/bin/env python
# Python Script installed and run directly on nexus BootFlash
...
# Execute this file via command : source ushow.py xxxxxx 
# where xxxxxx is the filename to collect all useful show commands Outputs
# (If no filename is provided, 1 filename is generated based on Time of day)
#
...
if len(sys.argv) >= 2:
	...
	print "To start ushow.py Script, use the following command : 'source ushow.py xxxxxx' "
	print "where xxxxxx is the Filename to collect all useful Show commands Outputs"
	print " \n"
	print "As no filename was specified, this filename, based on Time Of day, will be used :"
	print " ******  " + SHOW_OUPUT + " ******  "
	print " \n"
#
